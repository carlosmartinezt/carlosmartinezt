...
**Custom domain:** The site uses `carlosmartinezt.com` as the custom domain. The `public/CNAME` file tells GitHub Pages to serve from this domain. No `base` path is needed with a custom domain.
