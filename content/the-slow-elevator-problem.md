---
title: 'The Slow Elevator Problem'
description: 'What a case study about elevators taught me about the gap between understanding a problem and influencing its solution.'
pubDate: '2022-10-21'
author: 'Carlos Martinez Tuanama'
---

I read [a case study in HBR](https://hbr.org/2012/09/are-you-solving-the-right-problem) about how most organizations aren't rigorous enough in defining the problems they're trying to solve. They jump to solutions, waste resources, and end up pursuing initiatives that address the wrong thing entirely.
...
- **Expectations, not speed.** Newer tenants may have come from buildings with faster elevators. They're comparing. Older tenants have adjusted. The problem might be unmet expectations, not the wait itself.

- **Perceived value.** Higher floors often pay more rent. They might feel they deserve better service. The complaint isn't "I'm bored" but "I'm not getting what I'm paying for."

- **Loss of control.** Waiting feels bad when you can't do anything about it. The frustration isn't boredom. It's helplessness. Mirrors and TVs might work not because they entertain, but because they give you something to *do*.
...
1. How to influence what happens next, before it's too late
2. How to stay curious even after I think I've found the answer
