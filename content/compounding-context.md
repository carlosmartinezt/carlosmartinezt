...
description: 'What changed how I use AI: giving it access to my actual context and letting that context grow over time.'
pubDate: '2026-02-02'
...
Same with my to-do list. It's organized by urgency:

- **Immediate:** what needs attention now
- **Important but not urgent:** what I should plan for
- **Waiting on others:** what I need to follow up on

When I brain dump something new, Claude can help me figure out where it goes, what it connects to, what I might be forgetting.

## 🗂️ The system I use

I organize everything using something called PARA. It's just a way to keep things tidy:
...
## 🎙️ The other piece: Superwhisper

I use a dictation app called Superwhisper. Instead of typing everything, I just talk. This sounds minor but it changes how I think.

> When I type, I edit as I go. When I talk, I just get thoughts out.

Then Claude helps me make sense of them.

So my workflow often looks like:

1. **Talk** out loud about what's on my mind
2. **Superwhisper** transcribes it
3. **Claude** helps me organize it, connect it to what I'm already working on, figure out next steps
...
You're juggling multiple businesses, writing books, doing design work. You already experiment with tools. I think this could fit how your brain works:

- A **Project** for each book
- An **Area** for each business
- **Resources** for design references or templates you reuse
